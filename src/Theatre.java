...
// Создаем оперу и добавляем актеров
        Opera opera = new Opera("Белый пояс", 120, director1, musicAuthor, "либрето хз что это", 10);
        ...
        show.printActors();
        // Проверка что добавить существующего актера нельяз
        opera.changeActor(actor3,"Любавин");
